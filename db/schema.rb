...
ActiveRecord::Schema[7.1].define(version: 2024_05_08_003042) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "pg_building_id", null: false
  ...
  create_table "pg_buildings", force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.string "phone"
    t.string "address"
  ...
  create_table "room_bookings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "available_room_id", null: false
    t.index ["available_room_id"], name: "index_room_bookings_on_available_room_id"
  ...
  add_foreign_key "room_bookings", "available_rooms"
